<h2><a href="https://leetcode.com/problems/minimum-operations-to-make-the-array-increasing/">1827. Minimum Operations to Make the Array Increasing</a></h2><h3>Easy</h3><hr><div data-read-aloud-multi-block="true"><p>You are given an integer array <code>nums</code> (<strong>0-indexed</strong>). In one operation, you can choose an element of the array and increment it by <code>1</code>.</p>
...
<pre style="position: relative;"><strong>Input:</strong> nums = [1,5,2,4,1]
<strong>Output:</strong> 14
<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong>Example 3:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> nums = [8]
